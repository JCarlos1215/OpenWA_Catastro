...
describe('dispatchConversationMedia', () => {
  ...
  it('routes an inline PDF payload to sendDocument without a remote URL', async () => {
    const s = svc();
    await dispatchConversationMedia(s, 's', {
      chatId: 'c@c.us',
    ...
    expect(s.sendDocument).toHaveBeenCalledWith('s', {
      chatId: 'c@c.us',
      base64: 'data:application/pdf;base64,QUJD',
      mimetype: 'application/pdf',
      filename: 'catalogo.pdf',
